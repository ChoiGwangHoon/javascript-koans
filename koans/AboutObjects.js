describe("Objects", function () {
    ...
    it("함수값을 갖고있는 object property는 method로 사용 가능합니다.",
        function () {
            var megalomaniac = {
                mastermind: "Brain",
                henchman: "Pinky",
    ...
    it("object의 method를 사용할때는, this의 값은 해당 object입니다.",
        function () {
    ...
    it("object property는 지우거나 추가할 수 있습니다.",
        function () {
    ...
    it("prototype에 추가하면 모든 instance에서 사용 가능합니다.(prototype chain)",
        function () {
